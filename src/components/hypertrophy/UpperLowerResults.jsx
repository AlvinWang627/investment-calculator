    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          {/* Upper Day Summary */}
          <div className="mb-6">
            <h3 className="font-semibold text-lg mb-3">{t('workout.upperProgress')}</h3>
          ...
          {/* Lower Day Summary */}
          <div>
            <h3 className="font-semibold text-lg mb-3">{t('workout.lowerProgress')}</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              ...
              {t('workout.tipsContent.progressiveOverloadPPL', {
                max: repsMax,
                min: repsMin,
                increment: formatWeight(results.chartData.upper?.[Object.keys(results.chartData.upper)[0]]?.[0]?.weight ? 2.5 : 2.5, unit).split(' ')[1] // Fallback safety
              })}
            </p>
            <p>
            ...
            <p>
              <strong>{t('workout.order')}: </strong>{t('workout.tipsContent.orderDesc')}
            </p>
          </div>
        </CardContent>
      </Card>
